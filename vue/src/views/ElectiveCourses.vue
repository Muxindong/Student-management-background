<template>
  <div>
    <div>
      ...
      <kcsx style="margin-left: 10px">校公选课类别: </kcsx>
      <template>
        <el-select v-model="value3" placeholder="请选择" style="width: 100px" @change="publicelectiveChange">
          <el-option
    ...
    <el-table :data="tableData" height="600">
      ...
      <el-table-column prop="publicelective" label="校公选课类别">
      </el-table-column>
    ...
    <el-dialog title="课程信息" :visible.sync="dialogFormVisible" center width="30%">
      <el-form label-width="80px">
        ...
        <el-form-item label="校公选课类别">
          <el-input v-model="form.publicelective" autocomplete="off"></el-input>
        </el-form-item>
...
export default {
  ...
  methods:{
    //请求分页查询函数
    loadsearch(){
      this.request.get("http://localhost:9090/searchp",{
        params:{
          name:this.name,
          nature:this.nature,
          publicelective:this.publicelective,
          flag:this.flag,
    ...
    //改函数为改变课程属性后重新请求数据
    publicelectiveChange(value){
      console.log(value)
      this.publicelective=value
      this.loadsearch()
    },
